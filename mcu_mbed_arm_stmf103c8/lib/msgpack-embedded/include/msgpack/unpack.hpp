...
const size_t COUNTER_SIZE = sizeof(_msgpack_atomic_counter_t);
    ...
    #if defined(__MBED__)
        #define MSGPACK_UNPACKER_INIT_BUFFER_SIZE (32*32)
    #elif defined(__AVR__)
        #define MSGPACK_UNPACKER_INIT_BUFFER_SIZE (8*32)
    #else
    ...
    #if defined(__MBED__)
        #define MSGPACK_UNPACKER_RESERVE_SIZE (16*32)
    #elif defined(__AVR__)
        #define MSGPACK_UNPACKER_RESERVE_SIZE (4*32)
    #else
